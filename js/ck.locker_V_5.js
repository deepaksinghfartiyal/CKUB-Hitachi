        ...
        if (data.length > 0) {
            ...
            $(data).each(function () {
                ...
                if (this.FirstName !== null && this.FirstName !== '') {
                    html += '<span class="mod">Requested By : ' + this.FirstName + '</span>';
                }
                else {
                    html += '<span class="mod">Requested By : N/A </span>';
                }
                if (this.LoginEmail !== null && this.LoginEmai !== '') {
                    html += '<span class="mod">Email Address : ' + this.LoginEmail + '</span>';
                }
                else {
                    html += '<span class="mod">Email Address : N/A </span>';
                }
