...
var Builder = {
        ...
        if (typeof (Builder.permalinkId) != 'undefined') {
            ...
            Api.call(Api.endpoints.kitProducts, JSON.stringify({ guid: Builder.guid }), function (data) {
                ...
                if (data != null && data != 'undefined' && data.length > 0) {
                    ...
                    if (data.length === 3) {
                        IsOption2Hide = true;
                        $('.kit.option-menu-head [data-count=2]').html("OPTION 2");
                        $('.kit.option-menu-head [data-count=3]').html("OPTION 3");
                    }
                    //End
    ...
    getPricingFromAPI: function (pid) {
        ...
        function addPricingCodeLatest(modSkuWithSize) {
            if (modSkuWithSize.length == 1) {
                //Remove size
                let modSku = modSkuWithSize[0].substr(0, modSkuWithSize[0].lastIndexOf("-"))
                modSkuWithSize = [modSku];
            }
            var this_pricing_code = modSkuWithSize;
            Builder.garmentPricingCodes[modSkuWithSize] = 'loading';
            Api.call(Api.endpoints.getPricing, JSON.stringify({
                productID: this_pricing_code
            }), function (DataList) {
                if (DataList !== null) {
                    for (let i = 0; i < DataList.length; i++) {
                        let productname= DataList[0].ProductCode.split('-')[0]
                        if(DataList.length ==1) {
                            size = "onesize";
                        }
                        else {
                            size = DataList[i].ProductCode.slice(DataList[i].ProductCode.lastIndexOf('-') + 1);
                        }
                        Builder.garmentPricingCodes[this_pricing_code] = DataList[i].TotalPrice;
                        $('.sizing-chart-options .row[data-size="' + size + '"] .per-piece').html("");
                        $('.sizing-chart-options .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                        $('.sizing-chart-options .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                        Builder.updatePricing(null, true);
                    }
                }
                else {
                    for (let i = 0; i < Product.sizes.length; i++) {
                        Builder.garmentPricingCodes[this_pricing_code] = 0;
                        $('.sizing-chart-options .row[data-size="' + Product.sizes[i] + '"] .per-piece').html("");
                        $('.sizing-chart-options .row[data-size="' + Product.sizes[i] + '"] .per-piece').html('$<span></span>');
                        $('.sizing-chart-options .row[data-size="' + Product.sizes[i] + '"] .per-piece span').html("0.00");
                        Builder.updatePricing(null, true);
                    }
                }
            });
        }
        function addPricingCodeLatestW(modSkuWithSize) {
            var this_pricing_code = modSkuWithSize;
            Builder.garmentPricingCodes[modSkuWithSize] = 'loading';
            Api.call(Api.endpoints.getPricing, JSON.stringify({
                productID: this_pricing_code
                ...
                if (DataList != null) {
                    for (let i = 0; i < DataList.length; i++) {
                        size = DataList[i].ProductCode.slice(DataList[i].ProductCode.lastIndexOf('-') + 1);
                        Builder.garmentPricingCodesW[this_pricing_code] = DataList[i].TotalPrice;
                        $('.sizing-chart-options-women .row[data-size="' + size + '"] .per-piece').html("");
                        $('.sizing-chart-options-women .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                        $('.sizing-chart-options-women .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                        Builder.updatePricing(null, true);
                    }
                }
                else {
                    for (let i = 0; i < Product.wSizes.length; i++) {
                        Builder.garmentPricingCodesW[this_pricing_code] = 0;
                        $('.sizing-chart-options-women .row[data-size="' + Product.wSizes[i] + '"] .per-piece').html("");
                        $('.sizing-chart-options-women .row[data-size="' + Product.wSizes[i] + '"] .per-piece').html('$<span></span>');
                        $('.sizing-chart-options-women .row[data-size="' + Product.wSizes[i] + '"] .per-piece span').html("0.00");
                        Builder.updatePricing(null, true);
                    }
                }
            });
        ...
        if (Product.sku != null) {
            ...
            for (var i = 0; i < Product.sizes.length; i++) {
                data.push(modSku + "-" + Product.sizes[i]);
            }
            if (data.length > 0) {
                addPricingCodeLatest(data);
            }
        }
        if (Product.wSku != null) {
            let data = [];
            for (var i = 0; i < Product.wSizes.length; i++) {
                data.push(modSkuW + "-" + Product.wSizes[i]);
            }
            if (data.length > 0) {
                addPricingCodeLatestW(data);
            }
        }
        if (Product.sku != null) {
            for (var i = 0; i < Product.sizes.length; i++) {
    ...
    getKitPricingFromAPI: function (pid, kitNo) {
        ...
        function addPricingCodeForOption_2And_4_ShirtLatest(modSkuWithSize) {
            var this_pricing_code = modSkuWithSize;
            //console.log(this_pricing_code + ' is undefined, returning string and queuing price load');
            Builder.garmentPricingCodesW[this_pricing_code] = 'loading';
                    ...
                    case 3:
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-optionsForkit_1 .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_1 .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_1 .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 1);

                                //$('.sizing-chart-optionsForkit_3 .row[data-size="' + size + '"] .inputidmen').prop("disabled", false);
                                $('.sizing-chart-optionsForkit_3 .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_3 .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_3 .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 3);
                            }
                        }
                        break;
        ...
        function addPricingCodeFor_W_Option_2And_4_ShirtLatest(modSkuWithSize) {
            var this_pricing_code = modSkuWithSize;
            Builder.garmentPricingCodesW[this_pricing_code] = 'loading';
            Api.call(Api.endpoints.getPricing, JSON.stringify({
                productID: this_pricing_code
                    ...
                    case 3:
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-optionsForkit_1-women .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_1-women .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_1-women .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 1);
                                //$('.sizing-chart-optionsForkit_3-women .row[data-size="' + size + '"] .inputidwomen').prop("disabled", false);
                                $('.sizing-chart-optionsForkit_3-women .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_3-women .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_3-women .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 3);
                            }
                        }
                        break;
        ...
        function addPricingCodeForOption_2And_4_ShortsLatest(modSkuWithSize) {
            var this_pricing_code = modSkuWithSize;
            Builder.garmentPricingCodes[this_pricing_code] = 'loading';
                    ...
                    case 1:
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-kit_OPTION2_Shorts_Men  .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-kit_OPTION2_Shorts_Men  .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-kit_OPTION2_Shorts_Men  .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 1);
                            }
                        }
                        break;
                    case 3:
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-kit_OPTION4_Shorts_Men .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-kit_OPTION4_Shorts_Men  .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-kit_OPTION4_Shorts_Men  .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 3);
                            }
                        }
                        break;
        ...
        function addPricingCodeFor_W_Option_2And_4_ShortsLatest(modSkuWithSize) {
            var this_pricing_code = modSkuWithSize;
            //console.log(this_pricing_code + ' is undefined, returning string and queuing price load');
            Builder.garmentPricingCodesW[this_pricing_code] = 'loading';
                    ...
                    case 1:
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-kit_OPTION2_Shorts_women .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-kit_OPTION2_Shorts_women .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-kit_OPTION2_Shorts_women .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 1);
                            }
                        }
                        break;
                    case 3:
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-kit_OPTION4_Shorts_women .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-kit_OPTION4_Shorts_women .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-kit_OPTION4_Shorts_women .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 3);
                            }
                        }
                        break;
                    ...
                    case 2:
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-optionsForkit_0  .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_0  .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_0  .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 0);
                                //$('.sizing-chart-optionsForkit_2  .row[data-size="' + size + '"] .inputidmen').prop("disabled", false);
                                $('.sizing-chart-optionsForkit_2  .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_2  .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_2  .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 2);
                            }
                        }
                        break;
                    case 4:
                        ...
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-optionsForkit_4  .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_4  .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_4  .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 4);
                            }
                        }
                        break;
        ...
        function addPricingCodeWLatest(modSkuWithSize) {
            var this_pricing_code = modSkuWithSize;
            //console.log(this_pricing_code + ' is undefined, returning string and queuing price load');
            Builder.garmentPricingCodesW[this_pricing_code] = 'loading';
            Api.call(Api.endpoints.getPricing, JSON.stringify({
                    ...
                    case 2:
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-optionsForkit_0-women .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 0);

                                $('.sizing-chart-optionsForkit_2-women .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_2-women .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_2-women .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 2);
                            }
                        }
                        break;
                    case 4:
                        ...
                        if (DataList != null) {
                            for (let i = 0; i < DataList.length; i++) {
                                ...
                                $('.sizing-chart-optionsForkit_4-women .row[data-size="' + size + '"] .per-piece').html("");
                                $('.sizing-chart-optionsForkit_4-women .row[data-size="' + size + '"] .per-piece').html('$<span></span>');
                                $('.sizing-chart-optionsForkit_4-women .row[data-size="' + size + '"] .per-piece span').html(DataList[i].TotalPrice.toFixed(2));
                                Builder.updateKitPricing(null, true, 4);
                            }
                        }
                        break;
        ...
        var ProductName = ProductKit['kit_' + kitNo].PricingSku;
        var ProductDetail = ProductName.split("_");
        var TopName = ProductDetail[0];
        var BottomName = ProductDetail[1];
        if (BottomName !== undefined) {//It means it is option 4
            //For OPTION 2 and OPTION 4 Shirt and short prises
            if (ProductName === "SBDUSMB_SBRDSDP" || ProductName === "SBDUS63_SBRDS63" || ProductName === "SBDUS64_SBRDS64") {
                // Important--  Sending Shirt Name And Its Size in OPTION 2 and OPTION 4

                // For Men  Shirt  
                // if (ProductKit['kit_' + kitNo].sizesShirt) {
                //  for (var i = 0; i < ProductKit['kit_' + kitNo].sizesShirt.length; i++) {
                //   addPricingCodeForOption_2And_4_Shirt(TopName, ProductKit['kit_' + kitNo].sizesShirt[i]);
                // }
                //}
                ...
                if (ProductKit['kit_' + kitNo].sizesShirt) {
                    let data = [];
                    for (var i = 0; i < ProductKit['kit_' + kitNo].sizesShirt.length; i++) {
                        data.push(TopName + "-" + ProductKit['kit_' + kitNo].sizesShirt[i]);
                    }
                    if (data.length > 0) {
                        addPricingCodeForOption_2And_4_ShirtLatest(data);
                    }
                }

                //Important--  For Women, Shirt product

                // if (ProductKit['kit_' + kitNo].wsizesShirt) {
                //  for (var i = 0; i < ProductKit['kit_' + kitNo].wsizesShirt.length; i++) {
                //  addPricingCodeFor_W_Option_2And_4_Shirt(Product.wpricesShirt, ProductKit['kit_' + kitNo].wsizesShirt[i]);
                //}
                ...
                if (ProductKit['kit_' + kitNo].wsizesShirt) {
                    let data = [];
                    for (var i = 0; i < ProductKit['kit_' + kitNo].wsizesShirt.length; i++) {
                        data.push(Product.wpricesShirt + "-" + ProductKit['kit_' + kitNo].wsizesShirt[i]);
                    }
                    if (data.length > 0) {
                        addPricingCodeFor_W_Option_2And_4_ShirtLatest(data);
                    }
                    Builder.modSku = TopName;
                    Builder.modSkuW = Product.wpricesShirt;
                }
                ...
                // For Men Shorts  
                // if (ProductKit['kit_' + kitNo].sizesShorts) {
                // for (var i = 0; i < ProductKit['kit_' + kitNo].sizesShorts.length; i++) {
                //  addPricingCodeForOption_2And_4_Shorts(BottomName, ProductKit['kit_' + kitNo].sizesShorts[i]);
                //}
            }
            ...
            if (ProductKit['kit_' + kitNo].sizesShorts) {
                let data = [];
                for (var i = 0; i < ProductKit['kit_' + kitNo].sizesShorts.length; i++) {
                    data.push(BottomName + "-" + ProductKit['kit_' + kitNo].sizesShorts[i]);
                }
                if (data.length > 0) {
                    addPricingCodeForOption_2And_4_ShortsLatest(data);
                }
            }
            //For Woment shorts
            // if (ProductKit['kit_' + kitNo].wsizesShorts) {
            //    for (var i = 0; i < ProductKit['kit_' + kitNo].wsizesShorts.length; i++) {
            //     addPricingCodeFor_W_Option_2And_4_Shorts(Product.wpriceShorts, ProductKit['kit_' + kitNo].wsizesShorts[i]);
            //  }
            ...
            if (ProductKit['kit_' + kitNo].wsizesShorts) {
                let data = [];
                for (var i = 0; i < ProductKit['kit_' + kitNo].wsizesShorts.length; i++) {
                    data.push(ProductKit['kit_' + kitNo].wpriceShorts + "-" + ProductKit['kit_' + kitNo].wsizesShorts[i]);
                }
                if (data.length > 0) {
                    addPricingCodeFor_W_Option_2And_4_ShortsLatest(data);
                }
        ...
        if (kitNo === 1) {
            ...
            if (Product.sizesShirt) {
                let data = [];
                for (var i = 0; i < Product.sizesShirt.length; i++) {
                    data.push(TopName + "-" + Product.sizesShirt[i]);
                }
                if (data.length > 0) {
                    addPricingCodeForOption_2And_4_ShirtLatest(data);
                }
            ...
            if (Product.wsizesShirt) {
                let data = [];
                for (var i = 0; i < Product.wsizesShirt.length; i++) {
                    data.push(Product.wpricesShirt + "-" + Product.wsizesShirt[i]);
                }
                if (data.length > 0) {
                    addPricingCodeFor_W_Option_2And_4_ShirtLatest(data);
                }
            ...
            if (Product.sizesShorts) {
                let data = [];
                for (var i = 0; i < Product.sizesShorts.length; i++) {
                    data.push(BottomName + "-" + Product.sizesShorts[i]);
                }
                if (data.length > 0) {
                    addPricingCodeForOption_2And_4_ShortsLatest(data);
                }
            ...
            if (Product.wsizesShorts) {
                let data = [];
                for (var i = 0; i < Product.wsizesShorts.length; i++) {
                    data.push(Product.wpriceShorts + "-" + Product.wsizesShorts[i]);
                }
                if (data.length > 0) {
                    addPricingCodeFor_W_Option_2And_4_ShortsLatest(data);
                }
        ...
        if (ProductKit.kit_0.sku !== "STYLE DP" || ProductKit.kit_0.sku !== "STYLE 63" || ProductKit.kit_0.sku !== "STYLE 64" || ProductKit.kit_0.sku !== "STYLE 65" || ProductKit.kit_0.sku !== "STYLE 66" || ProductKit.kit_0.sku !== "STYLE 67" || ProductKit.kit_0.sku === "STYLE 68" || ProductKit.kit_0.sku === "STYLE 69") {
            if (kitNo === 3) {
                //Important--  Sending shorts Name And Its Size  in OPTION 2  
        ...
        if (kitNo === 0 || kitNo === 2 || kitNo === 4) {
            //for (var i = 0; i < ProductKit['kit_' + kitNo].sizes.length; i++) {
            //addPricingCode(modSku, ProductKit['kit_' + kitNo].sizes[i]);
            //}
            //if (Product.wSku != null) {
            //for (var i = 0; i < ProductKit['kit_' + kitNo].wSizes.length; i++) {
            //addPricingCodeW(modSkuW, ProductKit['kit_' + kitNo].wSizes[i]);
            //}
            //}
            //Builder.modSku = modSku;
            //Builder.modSkuW = modSkuW;
            ...
            let dataW = [];
            for (var i = 0; i < ProductKit['kit_' + kitNo].sizes.length; i++) {
                data.push(modSku + "-" + ProductKit['kit_' + kitNo].sizes[i]);
            }
            if (data.length > 0) {
                addPricingCodeLatest(data);
            }
            if (ProductKit['kit_' + kitNo].wSku !== null) {
                for (var i = 0; i < ProductKit['kit_' + kitNo].wSizes.length; i++) {
                    dataW.push(modSkuW + "-" + ProductKit['kit_' + kitNo].wSizes[i]);
                }
                if (dataW.length > 0) {
                    addPricingCodeWLatest(dataW);
                }
            }
            Builder.modSku = modSku;
            Builder.modSkuW = modSkuW;
    ...
    loadDesign: function () {
        Api.call(Api.endpoints.getDesign, JSON.stringify({
            ...
            if (data == null) {
                ...
                if (data.Product == "CE58" || data.Product == "CF5" || data.Product == "YSSK89") {
                    Builder.IssetUpfee = true;
                }
                //Set free zero for all CustomSublimatedSinglets
                if (data.Product == "S79REV43J" || data.Product == "S79CK43J" || data.Product == "S794324" || data.Product == "S74MB43J" || data.Product == "S794332" || data.Product == "S744343" || data.Product == "S794321" || data.Product == "S794339" || data.Product == "S794334" || data.Product == "S794337" || data.Product == "S794326" || data.Product == "S794322" || data.Product == "S794330" || data.Product == "S794327" || data.Product == "SCAC43J" || data.Product == "S7943J" || data.Product == "S794344" || data.Product == "S794345" || data.Product == "S794329" || data.Product == "S794318" || data.Product == "S794343" || data.Product == "S74GR43J" || data.Product == "S79CB43J" || data.Product == "S79OT43J" || data.Product == "SW79OKC" || data.Product == "S794356" || data.Product == "S794358" || data.Product == "S744357" || data.Product == "S742I43J" || data.Product == "SCAC59" || data.Product == "S794354" || data.Product == "S794352" || data.Product == "S794355" || data.Product == "S7943DT" || data.Product == "S74CB43J" || data.Product == "S794360" || data.Product == "S794364" || data.Product == "S79FTHR" || data.Product == "SCAC65" || data.Product == "S74UW43J" || data.Product == "S74GR2I" || data.Product == "S74MBDPJ" || data.Product == "S794363") {
                    Builder.IssetUpfee = true;
                }
    ...
    initUi: function () {
        ...
        $(".preview-nav a").bind('click', function (e) {
            ...
            var SelectedView = document.querySelector("#HideQuantitySizesInSinglet a.active").getAttribute("data-view");
            //or
            //SelectedView = $(this).attr("data-view");
            switch (Product.sku) {
                case "SBRDS68":
                case "SBDUS68":
                case "S744368":
                    if (SelectedView === "_Left" || SelectedView === "_Right") {
                        document.querySelector('#thebutton').style.pointerEvents = "none";
                    }
                    else {
                        document.querySelector("#thebutton").style.pointerEvents = "auto";
                    }
                    break;
                case "SCAC59":
                    if (SelectedView === "_Left" || SelectedView === "_Right") {
                        $(".single .button.stock-logos").css("pointer-events", "none");
                        document.getElementsByClassName("browse_upload")[0].disabled = true;
                    }
                    else {
                        $(".single .button.stock-logos").css("pointer-events", "auto");
                        document.getElementsByClassName("browse_upload")[0].disabled = false;
                    }
                    break;
                default:
                    text = "Someting going wrong!please contact";
            }
        });
        ...
        $(".button.stock-logos").bind('click', function (e) {
            e.preventDefault();
            let SelectedView = $(".preview-nav a.active").attr('data-view');
            if (Product.sku === "SCAC59" && (SelectedView === "_Left" || SelectedView === "_Right")) {
                $(".single .button.stock-logos").css("pointer-events", "none");
                document.getElementsByClassName("browse_upload")[0].disabled = true;
                return false;
            }
        ...
        if (step <= Builder.maxStep && step >= 0 && !$.QueryString['f']) {
            if ((step == 0 || step == 1 || step == 2 || step == 3 || step == 4) && Builder.userData.ID < 0) {
                ...
                if (Iskit == undefined) {
                    ...
                    //window.location = url;
                    if (ckstoreURL.includes("mcstaging") || ckstoreURL.includes("mcprod")) {
    ...
    setSvgColor: function (group, hex, code, image) {
        ...
        if (hex != null) {
            ...
            if ($("g[id^=" + group + "]").length > 0) {
                ...
                if (Product.sku === "L7443J") {
                    if (hex === "ff3600") {
                        $("g[id^='NECK_x2F_ARM_TRIM'] path, g[id^=" + group + "] rect, g[id^=" + group + "] polygon, g[id^=" + group + "] ellipse").attr("fill", "#000000");
                    }
                    if (hex === "0d3692" || hex === "d90026") {
                        $("g[id^='NECK_x2F_ARM_TRIM'] path, g[id^=" + group + "] rect, g[id^=" + group + "] polygon, g[id^=" + group + "] ellipse").attr("fill", "#ffffff");
                    }
                    if (hex === "011a32" || hex === "000000") {
                        $("g[id^='NECK_x2F_ARM_TRIM'] path, g[id^=" + group + "] rect, g[id^=" + group + "] polygon, g[id^=" + group + "] ellipse").attr("fill", "#ffc211");
                    }
                }
                if (Product.sku === "WS7593") {
                    if (hex === "011a32") {
                        $("g[id^='ID_NAVY_COLOR'] path, g[id^=" + group + "] rect, g[id^=" + group + "] polygon, g[id^=" + group + "] ellipse").attr("fill", "#011a32");
                    }
                    else {
                        $("g[id^='ID_NAVY_COLOR'] path, g[id^=" + group + "] rect, g[id^=" + group + "] polygon, g[id^=" + group + "] ellipse").attr("fill", "#000000");
                        $("g[id^='SHADING'] path, g[id^=" + group + "] rect, g[id^=" + group + "] polygon, g[id^=" + group + "] ellipse").attr("fill", "#1F1916");
                    }
                }
                if (Product.sku === "S744368" && group === "BODY") {
                    switch (hex) {
                        case "887e75":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#636363");
                            break;
                        case 636363:
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#887e75");
                            break;
                        case "ffc211":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#FEE739");
                            break;
                        case "FEE739":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#ffc211");
                            break;
                        case "0d3692":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#3399cc");
                            break;
                        case "3399cc":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#0d3692");
                            break;
                        case "005027":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#23d202");
                            break;
                        case "23d202":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#005027");
                            break;
                        case "0a0345":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#0d3692");
                            break;
                        case "0d3692":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#0a0345");
                            break;
                        case 381100:
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#63002f");
                            break;
                        case "63002f":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#381100");
                            break;
                        case "000000":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#011a32");
                            break;
                        case "011a32":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#000000");
                            break;
                        case "a7001f":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#d90026");
                            break;
                        case "d90026":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#a7001f");
                            break;
                        case "ff3600":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#d90026");
                            break;
                        ...
                        case "011a32":
                            ...
                            break;
                        case "ba9800":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#fee0ad");
                            break;
                        case "fee0ad":
                            $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#ba9800");
                            break;
                        default:
    ...
    setKitSvgColor: function (group, hex, code, image, kitNo) {
        if (hex != null) {
            if ($(".kits.kit_" + kitNo + " g[id^=" + group + "]").length > 0) {
                ...
                if (ProductKit.kit_0.sku === "STYLE 68" || ProductKit.kit_2.sku === "S744368-SINGLET") {
                    if (group === "BODY") {
                        switch (hex) {
                            case "887e75":
                                $("g[id^='PATTERN_GRAPHIC'] path, g[id^='PATTERN_GRAPHIC'] rect, g[id^='PATTERN_GRAPHIC'] polygon, g[id^='PATTERN_GRAPHIC'] ellipse").attr("fill", "#636363");
                ...
                $(this).click(function (e) {
                    ...
                    if ($(this).data('code') == "NY" || $(this).data('code') == "BK" || $(this).data('code') == "PR" || $(this).data('code') == "NYSG" || $(this).data('code') == "BKOR" || $(this).data('code') == "NYCB" || $(this).data('code') == "BKSG" || $(this).data('code') == "BKSC" || $(this).data('code') == "NYVG") {
                        ...
                        if (Product.BOXCOLOR != "DEFAULT") {
                            if (Product.sku === "WS7593" && $(this).data('code') === "SC" || $(this).data('code') === "CB") {
                                $("g[id^=BOX] *").attr('stroke', '#00FF99');
                            }
                            else {
    ...
    compileReview: function () {
        ...
        if (Product.sku === "SW74U43J" || Product.sku === "S74UW43J") {
            if (Builder.viewsLoaded === Builder.viewsToLoad) {
                ...
                if (textCount === 0) {
                    ...
                    var Mask = svgText.layerObjects["_Back"][textCount].mask;
                    var statement = true;
                    if (textCount <= 1) {
                        if (Location === "Country" || Mask === "XYZ") {
                            ...
                            if (Location !== "Body") {
                                if ($('#text_palette_Back .mask-panel').find(':selected').text() !== "NameCountry") {
                                    $('#CountryName').text("COUNTRY");
                                }
                        ...
                        if (statement) {
                            if (Location === "Name" || Mask === "MASKNAME") {
                                $('#svgName').text("");
                            }
                            else {
                                if (Location !== "Body") {
        ...
        if (Printing) {
            ...
            if (Printing.length === 0) {
                ...
                if (Printing === undefined) {
                    if ($('#print_type').html() === '') {
                        Printing = $('input:checked', '#print_typeBasedOnColor').val();
                        if (Printing === undefined) {
                            Printing = $('#print_typeBasedOnColor label').text();
                        }
                    }
                }
            }
    ...
    createProductList: function () {
        ...
        */
        ...
        //art
        //Remove SUBLTR charges from this category CustomSublimatedSinglets
        if (Product.sku !== "CKWRAP" && Product.sku !== "S79REV43J" && Product.sku !== "S79CK43J" && Product.sku !== "S794324" && Product.sku !== "S74MB43J" && Product.sku !== "S794332" && Product.sku !== "S744343" && Product.sku !== "S794321" && Product.sku !== "S794339" && Product.sku !== "S794334" && Product.sku !== "S794337" && Product.sku !== "S794326" && Product.sku !== "S794322" && Product.sku !== "S794330" && Product.sku !== "S794327" && Product.sku !== "SCAC43J" && Product.sku !== "S7943J" && Product.sku !== "S794344" && Product.sku !== "S794345" && Product.sku !== "S794329" && Product.sku !== "S794318" && Product.sku !== "S794343" && Product.sku !== "S74GR43J" && Product.sku !== "S79CB43J" && Product.sku !== "S79OT43J" && Product.sku !== "SW79OKC" && Product.sku !== "S794356" && Product.sku !== "S794358" && Product.sku !== "S744357" && Product.sku !== "S742I43J" && Product.sku !== "SCAC59" && Product.sku !== "S794354" && Product.sku !== "S794352" && Product.sku !== "S794355" && Product.sku !== "S7943DT" && Product.sku !== "S74CB43J" && Product.sku !== "S794360" && Product.sku !== "S794364" && Product.sku !== "S79FTHR" && Product.sku !== "SCAC65" && Product.sku !== "S74UW43J" && Product.sku !== "S74GR2I" && Product.sku !== "S74MBDPJ" && Product.sku !== "S794363") {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    if (response != "" || response != null) {
                                        ...
                                        if (fee == "") {
                                            var detailWithSetupFee = Builder.createProductList();
                                        }
                                        else {
                                            var detailWithSetupFee = Builder.createProductList() + ',' + fee;
                                        }
                                        ...
                                        //apply condition for magento site
                                        if (ckstoreURL.includes("mcstaging") || ckstoreURL.includes("mcprod")) {
                                            if (ckstoreURL.includes("mcstaging"))
                                                ckstoreURL = "https://mcstaging.cliffkeen.com"
                                            else
                                                ckstoreURL = "https://mcprod.cliffkeen.com"
                                            $.ajax({
                                                crossDomain: true,
                                                url: ckstoreURL + "/AddToCart",
                                                data: { lstChildProduct: detailWithSetupFee, designId: request, originalOrderNo: originalOrderNo,CustomerId:Builder.userData.ID},
...
$('.lds-wrapper').removeClass('kit_4');
    ...
    kitClick: function (type) {
        ...
        if (!Builder.validateKitStepNew(1, null, kitNo)) {
            ...
            if (kitNo == 0) {
                //Show Product Name here....
                if (Builder.kitproductNewfor_0.length !== 0) {
                ...
                //Show Product Name here....
                if (Builder.kitproductNewfor_1.length !== 0) {
                    arr = Builder.kitproductNewfor_1.sku.split('-');
                    var shirt = arr[0];
                    var shorts = arr[1];
                    $(".kits.kit_" + kitNo + " .product-title .text").text(shirt + ' ' + 'SHIRT' + ' ' + '-' + ' ' + shorts + ' ' + 'SHORTS');
                ...
                if (Builder.kitproductNewfor_3.length !== 0) {
                    arr = Builder.kitproductNewfor_3.sku.split('-');
                    var shirt = arr[0];
                    var shorts = arr[1];
                    $(".kits.kit_" + kitNo + " .product-title .text").text(shirt + ' ' + 'SHIRT' + ' ' + '-' + ' ' + shorts + ' ' + 'SHORTS');
    ...
    PreviewClick: function () {
        $(".preview-nav.kits a").bind('click', function (e) {
            e.preventDefault();
            var kitNo = parseInt($(this).parent().closest('div').attr('class').match(/\d+/)[0]);
            let SelectedView = $(this).attr("data-view");
            if (ProductKit.kit_0.sku === "STYLE 59") {
                if ((kitNo === 0 || kitNo === 1 || kitNo === 2 || kitNo === 3) && (SelectedView === "_Left" || SelectedView === "_Right")) {
                    $(".kit_" + kitNo + " .button.stock-logos").css("pointer-events", "none");
                    document.getElementsByClassName("custom-browse")[kitNo].disabled = true;
                }
                else {
                    $(".kit_" + kitNo + " .button.stock-logos").css("pointer-events", "auto");
                    document.getElementsByClassName("custom-browse")[kitNo].disabled = false;
                }
            }
            if (ProductKit.kit_0.sku === "STYLE 68" && (SelectedView === "_Left" || SelectedView === "_Right")) {
                document.querySelector('#thebutton_' + kitNo).style.pointerEvents = "none";
            }
            else {
                document.querySelector('#thebutton_' + kitNo).style.pointerEvents = "auto";
            }
            var position = $(this).data('view');
        ...
        if ($('body').hasClass("front-only") && kitNo == 0) {
            ...
            switch (Product.sku) {
                ...
                case 'STYLE 61':
                    ...
                    break;
                case 'STYLE 63':
                    $(".kits.kit_" + kitNo + " .product-title .text").text(Product.ProductName + '(' + 'STYLE 63' + ')');
                    break;
                case 'STYLE 64':
                    $(".kits.kit_" + kitNo + " .product-title .text").text(Product.ProductName + '(' + 'STYLE 64' + ')');
                    break;
                case 'STYLE DP':
                    $(".kits.kit_" + kitNo + " .product-title .text").text(Product.ProductName + '(' + 'STYLE DP' + ')');
                    break;
                case 'STYLE 65':
                    $(".kits.kit_" + kitNo + " .product-title .text").text(Product.ProductName + '(' + 'STYLE 65' + ')');
                    break;
                case 'STYLE 66':
                    $(".kits.kit_" + kitNo + " .product-title .text").text(Product.ProductName + '(' + 'STYLE 66' + ')');
                    break;
                case 'STYLE 67':
                    $(".kits.kit_" + kitNo + " .product-title .text").text(Product.ProductName + '(' + 'STYLE 67' + ')');
                    break;
                case 'STYLE 68':
                    $(".kits.kit_" + kitNo + " .product-title .text").text(Product.ProductName + '(' + 'STYLE 68' + ')');
                    break;
                case 'STYLE 69':
                    $(".kits.kit_" + kitNo + " .product-title .text").text(Product.ProductName + '(' + 'STYLE 69' + ')');
                    break;
                default:
                    break;
    ...
    loadKitProduct: function (data, kitNo) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                //after referesh the page data will not dispay in kit 4 shorts
                //loadtime++;
                //if (IsOption2Hide === true && loadtime === 3) {
                //    Api.call(Api.endpoints.getDesign, JSON.stringify({
                //        guid: Builder.guid
                //    }), function (data) {
                //        if (data.Customization !== null) {
                //            var da = JSON.parse(data.Customization);
                //            var ActiveKit = da.kitID;
                //            //if (ActiveKit === "2") {
                //            //    Builder.kitClick("4");
                //            //}
                //            Builder.kitClick(ActiveKit);
                //        }
                //    });
                //}
                //else {
    ...
    if (code === "BK" || code === "NY" || code == "SC") {
        ...
        if (PrintingType && PrintingType !== null) {
            ...
            if (PrintingType.length === 0) {
                ...
                $('#print_typeBasedOnColor').append("<label>Screen Printing</label>");
