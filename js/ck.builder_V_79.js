...
var Builder = {
    ...
    SaveandSharebutton: function () {
        ...
        if ($("#ForSingleProduct" + CurrentView + " style").html() === undefined) {
            $("#ForSingleProduct" + CurrentView + " svg").prepend("<style>@import url("+deepSiteUrl+"/css/svg_text.css)</style><style>@import url(" + deepSiteUrl + "/css/fonts/stylesheet.css)</style>");
        }
        if (CurrentView == "_Front") {
