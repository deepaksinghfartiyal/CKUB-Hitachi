...
var Builder = {
  ...
  //End
    ...
    SaveandSharebutton: function () {
        ...
        var CurrentView = $(".preview-nav a.active").attr('data-view');
        // var svgText = $('.svg:first-child').html();       
        //get html of all the svg
        //$('#ForSingleProduct').find('.svg').each(function (i, obj) {           
        //    svgText = svgText + $(obj).html()
        //});          
        if (CurrentView == "_Front") {
            var svgText = $('#ForSingleProduct_Front:first-child').html();
        }
        ...
        //    paintSvgToCanvas(document.getElementById('source'), document.getElementById('mySvgCanvasforsaveshare'));
        ...
        //    console.log(d.createTextNode('data:image/svg+xml;base64,' + base64));
        //}
        //(window, document));
    ...
    displayKitProduct: function (kitNo, KitProduct) {
        ...
        if ($('body').hasClass("front-only") && kitNo == 0) {
            ...
            $(Product.sizesShirt).each(function () {
                var html = '<div class="row" data-size="' + this + '">';
                html += '<div class="col"><strong>' + this + '</strong></div>';
                html += '<div class="col men">:<input class="inputidmen" type="text" value="0" autocomplete="off" onkeydown="return tabevent(this,' + kitNo + ',event)" onkeypress="return isNumberKey(event)" onchange="return totalPrice(' + kitNo + ')"  name="' + this + '" /></div>';
                //html += '<div class="col per-piece">N/A<span></span></div>';
                html += '<div class="col per-piece">$0.00<span></span></div>';
                html += '<div class="col piece-total">0.00</div>';
                html += '</div>';
            ...
            $(Product.wsizesShirt).each(function () {
                var html = '<div class="row" data-size="' + this + '">';
                html += '<div class="col"><strong>' + this + '</strong></div>';
                html += '<div class="col women">:<input class="inputidwomen" type="text" value="0" autocomplete="off" onkeydown="return tabevent(this,' + kitNo + ',event)" onkeypress="return isNumberKey(event)" onchange="return totalPrice(' + kitNo + ')"  name="' + this + '" /></div>';
                //html += '<div class="col per-piece">N/A<span></span></div>';
                html += '<div class="col per-piece">$0.00<span></span></div>'
                html += '<div class="col piece-total">0.00</div>';
                html += '</div>';
            ...
            $(Product.sizesShorts).each(function () {
                ...
                var html = '<div class="row" data-size="' + this + '">';
                html += '<div class="col"><strong>' + this + '</strong></div>';
                html += '<div class="col men">:<input class="inputidmen" type="text" value="0" onkeydown="return tabevent(this,' + kitNo + ',event)" autocomplete="off" onkeypress="return isNumberKey(event)" onchange="return totalPrice(' + kitNo + ')"  name="' + this + '" /></div>';
                //html += '<div class="col per-piece">N/A<span></span></div>';
                html += '<div class="col per-piece">$0.00<span></span></div>';
                html += '<div class="col piece-total">0.00</div>';
                html += '</div>';
            ...
            $(Product.wsizesShorts).each(function () {
                ...
                var html = '<div class="row" data-size="' + this + '">';
                html += '<div class="col"><strong>' + this + '</strong></div>';
                html += '<div class="col women">:<input class="inputidwomen" type="text" value="0" onkeydown="return tabevent(this,' + kitNo + ',event)" autocomplete="off" onkeypress="return isNumberKey(event)" onchange="return totalPrice(' + kitNo + ')"  name="' + this + '" /></div>';
                //html += '<div class="col per-piece">N/A<span></span></div>';
                html += '<div class="col per-piece">$0.00<span></span></div>';
                html += '<div class="col piece-total">0.00</div>';
                html += '</div>';
            ...
            if (Product.wSku != null) {
                $(Product.wSizes).each(function () {
                    var html = '<div class="row" data-size="' + this + '">';
                    html += '<div class="col"><strong>' + this + '</strong></div>';
                    html += '<div class="col women">:<input class="inputidwomen" type="text" value="0" onkeydown="return tabevent(this,' + kitNo + ',event)" autocomplete="off" onkeypress="return isNumberKey(event)" onchange="return totalPriceWomen(' + kitNo + ')" name="' + this + '" /></div>';
                    //html += '<div class="col per-piece">N/A<span></span></div>';
                    html += '<div class="col per-piece">$0.00<span></span></div>';
                    html += '<div class="col piece-total">0.00</div>';
                    html += '</div>';
            ...
            $(Product.sizesShorts).each(function () {
                ...
                var html = '<div class="row" data-size="' + this + '">';
                html += '<div class="col"><strong>' + this + '</strong></div>';
                html += '<div class="col men">:<input class="inputidmen" type="text" onkeydown="return tabevent(this,' + kitNo + ',event)" value="0" autocomplete="off" onkeypress="return isNumberKey(event)" onchange="return totalPrice(' + kitNo + ')"  name="' + this + '" /></div>';
                //html += '<div class="col per-piece">N/A<span></span></div>';
                html += '<div class="col per-piece">$0.00<span></span></div>';
                html += '<div class="col piece-total">0.00</div>';
                html += '</div>';
            ...
            $(Product.wsizesShorts).each(function () {
                ...
                var html = '<div class="row" data-size="' + this + '">';
                html += '<div class="col"><strong>' + this + '</strong></div>';
                html += '<div class="col women">:<input class="inputidwomen" type="text" onkeydown="return tabevent(this,' + kitNo + ',event)" value="0" autocomplete="off" onkeypress="return isNumberKey(event)" onchange="return totalPrice(' + kitNo + ')"  name="' + this + '" /></div>';
                //html += '<div class="col per-piece">N/A<span></span></div>';
                html += '<div class="col per-piece">$0.00<span></span></div>';
                html += '<div class="col piece-total">0.00</div>';
                html += '</div>';
    ...
    initKitUi: function (kitNo, KitProduct) {
        ...
        $("#SubmitEmail").on('click', function (e) {
            ...
            if (counter == 0) {
                ...
                switch (loadView) {
                    case 1:
                        // Builder.ConvertSVGintoPNGforDealerForSingleViewsForKit();
                        break;
                    case 2:
                        // Builder.ConvertSVGintoPNGforDealerForTwoViewsForKit();
                        break;
                    case 3:
                        //Builder.ConvertSVGintoPNGforDealerForThreeViewsForKit();
                        break;
                    case 4:
                        // Builder.ConvertSVGintoPNGforDealerForFourViewsForKit();
                        break;
                }
            }
            //counter = 1;     
            ...
            if (Quantity != null) {
                ...
                $(Product.wSizes).each(function () {
                    if (Quantity.sizes[this] == '0') {
                        ...
                        $('.sizing-chart-optionsForkit_0-women [name="' + this + '"]').val(Quantity.sizes[this]);
                    }
                    Builder.cartObj0['w'][this] = Quantity.sizes[this];
                });
            } else {
                console.log('no quants to show');
...
function GmailShare(CurrentUrl) {
    var id = sessionStorage.getItem("CurrentImagePath_Email");
    var CurrentLoggedInUser = sessionStorage.getItem("GetCurrentLoggedInUser");
        ...
        if (code === "WH" || code === "GY" || code === "SG") {
            ...
            if (PrintingType || PrintingType !== null) {
                if (PrintingType.length === 0) {
                    ...
                    $('#print_typeBasedOnColor').append("<input type='radio' checked class='chkBasedOnColorFirst' name='PrintingTypeValueForColor' value='Screen Printing'><label>Screen Printing</label>");
                    $('#print_typeBasedOnColor').append("<input type='radio' class='chkBasedOnColorFirst' name='PrintingTypeValueForColor' value='Spot Sublimation'><label>Spot Sublimation</label>");
                }
                else {
                    //select this radio button which is saved in Db
                    $('#print_typeBasedOnColor').html('');
                    $('#print_typeBasedOnColor').append("<input type='radio' class='chkBasedOnColorFirst' id='FirstPrintId_0' name='PrintingTypeValueForColor' value='Screen Printing'><label>Screen Printing</label>");
                    $('#print_typeBasedOnColor').append("<input type='radio' class='chkBasedOnColorFirst' id='FirstPrintId_1' name='PrintingTypeValueForColor' value='Spot Sublimation'><label>Spot Sublimation</label>");
    ...
    if (group === "BODY")
        if (code === "WH" || code === "GY" || code === "SG") {
            ...
            if (PrintingType || PrintingType !== null) {
                if (PrintingType.length === 0) {
                    $('#print_typeBasedOnColor').html('');
                    $('#print_typeBasedOnColor').append("<input type='checkbox' checked class='chkBasedOnColorFirst' name='PrintingTypeValueForColor_0' value='Screen Printing'><label>Screen Printing</label>");
                    $('#print_typeBasedOnColor').append("<input type='checkbox' class='chkBasedOnColorFirst' name='PrintingTypeValueForColor_1' value='Spot Sublimation'><label>Spot Sublimation</label>");
                }
                else {
                    //checked those checked boxes which are saved in Db
                    $('#print_typeBasedOnColor').html('');
                    $('#print_typeBasedOnColor').append("<input type='checkbox' class='chkBasedOnColorFirst' name='PrintingTypeValueForColor_0' value='Screen Printing'><label>Screen Printing</label>");
                    $('#print_typeBasedOnColor').append("<input type='checkbox' class='chkBasedOnColorFirst' name='PrintingTypeValueForColor_1' value='Spot Sublimation'><label>Spot Sublimation</label>");
