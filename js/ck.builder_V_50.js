    ...
    sendKitFiles: function (type, kitNo) {
        ...
        $.ajax({
            ...
            beforeSend: function () {      // Important-Hide loader while uploading Browse image in Artwork
                $(".lds-wrapper").show();
                if (kitNo === 4) {
                    $('.lds-wrapper').addClass('kit_4_loader');
                    $('body').addClass('kit_4_loader');
                }
                else {
                    if ($(".lds-wrapper").hasClass("kit_4_loader") && $("body").hasClass("kit_4_loader")) {
                        $('.lds-wrapper').removeClass('kit_4_loader');
                        $('body').removeClass('kit_4_loader');
                    }
                }
            },
            cache: false,
